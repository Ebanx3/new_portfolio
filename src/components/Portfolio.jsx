const Portfolio = ({ inEsp, darkMode }) => {
  return (
    <div>
      <div className="flex justify-center flex-col lg:flex-row items-center mb-5 w-full 2xl:w-4/5 m-auto p-2">
      ...
      <div className="flex justify-center flex-col lg:flex-row items-center mb-5 w-full 2xl:w-4/5 m-auto p-2 mt-8">
        <img
